...
import minus from "../../assets/icon-decrement-quantity.svg"
  ...
  return (
    <div className="productItemContainer">
      ...
      <div className="productDetails">
        ...
        >
          <button onClick={() => addItemToCart(product)} className='cartBtn'><img src={addToCart} alt="cart button" /><span>Add to Cart</span></button>
